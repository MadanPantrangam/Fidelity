...
namespace Day01.Day10
{
    ...
    class MovieApp
    {
        ...
        static MovieDatabase app = new MovieDatabase();
        ...
        private static void AddNewMovieDetails()
        {
            movie.MovieTitle = HelperClass.GetString("Enter Movie Title : ");
            movie.ReleaseDate = HelperClass.GetDate("Enter Release Date");
            movie.Rating = HelperClass.GetNumber("Enter Movie Rating : ");
            movie.Director = HelperClass.GetString("Enter Director Name");
            movie.Duration = HelperClass.GetNumber("Enter Movie Duration");
            app.AddNewMovieToDatabase(movie);
        }
    }
}